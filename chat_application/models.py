...
class ChatGroup(models.Model):
    ...
    admin=models.ForeignKey(User,related_name='groupcharts',blank=True,null=True,on_delete=models.SET_NULL)
...
class GroupMessage(models.Model):
    ...
    def __str__(self):
        if self.body:
            ...
            return f'{self.author.username}: {self.filename or "file"}'
